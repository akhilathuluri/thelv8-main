...
export default function AdminProductsPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Calculate total stock from stock_by_size
      ...
      const productData = {
        ...
        slug: slug,
        stock: totalStock,
        stock_by_size: formData.stockBySize,
        images: imagesArray,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="md:col-span-2">
                ...
                <div className="text-xs text-stone-500 mb-3">
                  Total Stock: {Object.values(formData.stockBySize).reduce((sum, qty) => sum + (qty || 0), 0)} units
                </div>
                {formData.sizes.filter(s => s.trim()).length > 0 ? (
                  ...
                  <div className="text-sm text-stone-500 italic p-4 bg-stone-50 rounded-lg">
                    Please enter sizes first (e.g., S, M, L, XL) to manage stock per size
                  </div>
                )}
              </div>
